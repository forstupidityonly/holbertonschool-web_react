...
describe('Test Notifications', () => {
  ...
  it('verify that the first NotificationItem element renders the right html', () => {
    const wrapper = shallow(<Notifications displayDrawer={true} listNotifications={listNotifications}  />);
    expect(wrapper.find(NotificationItem).first().html()).toEqual('<li class="defaultNotificationStyle_1tsdo2i-o_O-smallNotificationStyle_1eafryi\" data-notification-type=\"default\">New course available</li>');
  });
  ...
  it('verify component doesent re-render when passed same props', () => {

  });

  it('verify component does re-render when passed more props', () => {
